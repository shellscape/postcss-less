const { atEndPattern, openedCurlyBracket, pageSelectorPattern, variableSpaceColonPattern, variablePattern, wordEndPattern } = require('./globals');
const unclosed = require('./unclosed');

module.exports = function tokenizeAtRule (state) {
